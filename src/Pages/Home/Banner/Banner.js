            ...
            <div className="hero  bg-gradient-to-r from-[#fed5db] to-[#fcb2bc] pb-4 shadow-xl px-[5%]">
                <div className="hero-content flex-col lg:flex-row-reverse lg:pr-4">
                    ...
                    <div className='mt-8 lg:ml-1'>
                        ...
                        <p className="text-md text-gray-500 mb-8 font-sans pl-4 border-neutral-400 border-l-8">Over 1 million people around the country are giving and getting cheap/free second hand dresses in their local communities. Just explore and order from our verified sellers and buyers.</p>
